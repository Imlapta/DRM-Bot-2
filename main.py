...
# Config 
class Config(object):
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "7902778109:AAG6uGwh-C6_STHbjsnXFKgZaJsiYHgtMEQ")
    API_ID = int(os.environ.get("API_ID",  "3737117"))
    API_HASH = os.environ.get("API_HASH", "f466ca6ff400954d192ce0992ddf8b5d")
    DOWNLOAD_LOCATION = "./DOWNLOADS"
    SESSIONS = "./SESSIONS"

    AUTH_USERS = os.environ.get('AUTH_USERS', '1110590703').split(',')
